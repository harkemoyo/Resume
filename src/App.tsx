      ...
      <ApolloProvider client={client}>
        <Router basename={BASE_PATH}>
          <div className="single-page-app">
            ...
            <Route 
              ...
              element={
                <>
                  <section id="hero">
                    <Header
                      profileImage="/images/passport.webp"
                      name="Hark Ndeche"
            ...
            <Route path="/account" element={<ProtectedRoute><CustomUserProfile /></ProtectedRoute>} />
            {/* Route user pages to CustomUserProfile */}
            <Route path="/user" element={<ProtectedRoute><CustomUserProfile /></ProtectedRoute>} />
            <Route path="/user-profile" element={<ProtectedRoute><CustomUserProfile /></ProtectedRoute>} />
