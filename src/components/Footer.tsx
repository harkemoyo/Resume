      ...
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            <li><Link to="/" className={`footer-link ${location.pathname === '/' || location.pathname === '/bio' ? 'active' : ''}`}>Home</Link></li>
            <li><Link to="/experience" className={`footer-link ${location.pathname === '/experience' ? 'active' : ''}`}>Experience</Link></li>
            <li><Link to="/contact" className={`footer-link ${location.pathname === '/contact' ? 'active' : ''}`}>Contact Me</Link></li>
          </ul>
        </div>
